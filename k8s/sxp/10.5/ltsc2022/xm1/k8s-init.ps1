...
function Invoke-K8sInit {
    ...
    $k8sSecretArray = @{ 
        ...
        "sitecore-solr-admin-username.txt" = $SolrAdminUserName
        "sitecore-solr-admin-password.txt" = $SolrAdminPassword
        "sitecore-solr-connection-username.txt" = $SolrConnectionUserName
        "sitecore-solr-connection-password.txt" = $SolrConnectionPassword
        "sitecore-solr-protocol.txt" = $SolrProtocol
        "sitecore-solr-instance.txt" = $SolrInstance
        "sitecore-solr-port.txt" = $SolrPort
    }
